  ...
  return (
    <div className="space-y-4 w-full max-w-full overflow-x-hidden">
      ...
      <div className="relative w-full max-w-full">
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 w-full max-w-md mx-auto max-w-full overflow-x-hidden">
          {/* Market Penetration */}
          <div
            className={`p-3 sm:p-4 rounded-lg border-2 transition-all duration-300 w-full max-w-full min-w-0 ${
        ...
        {/* Axis Labels */}
        <div className="mt-4 text-center w-full max-w-full">
          <div className="text-sm font-medium text-[color:var(--foreground)] opacity-80 break-words">
            Market: Existing ← → New
          </div>
